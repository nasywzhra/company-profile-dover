            ...
            <form action="{{ route('login') }}" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input id="email" type="email" name="email"
                        class="form-control @error('email') is-invalid @enderror rounded-pill input-login shadow-img"
                ...
                <div class="mb-3">
                    ...
                    <input type="password" name="password" id="password"
                        class="form-control @error('password') is-invalid @enderror rounded-pill input-login shadow-img"
                ...
                <div class="text-center">
                    <button type="submit" class="btn btn-info rounded-pill btn-login text-capitalize shadow-img">Login</button>
                </div>
            </form>
        </div>
    </section>
